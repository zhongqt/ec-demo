...
//全局配置，如果采用默认均不需要改动
    var config = {
        path: window.ctx + '/bower_components/laydate/', //laydate所在路径
...
//时分秒的有效检测
    ...
    /**add by wengms 2015-06-12 增加对闰年以及月份天数的合法性判断 begin**/
    Dates.checkDateIsValid = function(){
        var reg = /((^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(10|12|0?[13578])([-\/\._])(3[01]|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(11|0?[469])([-\/\._])(30|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(0?2)([-\/\._])(2[0-8]|1[0-9]|0?[1-9])$)|(^([2468][048]00)([-\/\._])(0?2)([-\/\._])(29)$)|(^([3579][26]00)([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][0][48])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][0][48])([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][2468][048])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][2468][048])([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][13579][26])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][13579][26])([-\/\._])(0?2)([-\/\._])(29)$))/
        value = Dates.elem[as.elemv].trim();
        if(value.length > 10){
            value = value.substr(0,10);
        }
        if(!reg.test(value)){
            Dates.elem[as.elemv] = '';
            Dates.msg('输入的日期不在有效期内,请重新输入.');
            return 1;
        }
    }
    /**add by wengms 2015-06-12 增加对闰年以及月份天数的合法性判断 end**/
//检测日期是否合法
...
//事件
    Dates.events = function () {
        ...
        Dates.on(doc, 'mouseup', function () {
            ...
            /*add by wengms V1.00.00 增加对tab事件的检查判断　begin*/
            if (codes === 9 && Dates.elem) {
                var box = S('#' + as[0]);
                if (box && box.style.display !== 'none') {
                    Dates.check() || Dates.close();
                }
            }
            /*add by wengms V1.00.00 增加对tab事件的检查判断　end*/
        });
