...
public class QTeacher extends BaseModelExpression<Teacher, Long> {
    ...
    public static final FieldExpression<String> teacherGender = teacher.fieldOf("teacherGender", String.class);
    public static final FieldExpression<String> sex = teacher.fieldOf("sex", String.class);
