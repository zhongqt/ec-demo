...
public class QBcPublicOrder extends BaseModelExpression<BcPublicOrder, BigDecimal> {

    public static final BaseModelExpression<BcPublicOrder, BigDecimal> bcPublicOrder = new QBcPublicOrder();
    public static final FieldExpression<BigDecimal> bcPublicOrderId = bcPublicOrder.fieldOf("bcPublicOrderId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> publicGoOrderId = bcPublicOrder.fieldOf("publicGoOrderId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> publicProjectId = bcPublicOrder.fieldOf("publicProjectId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> publicNoOfPackage = bcPublicOrder.fieldOf("publicNoOfPackage", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> recordVersion = bcPublicOrder.fieldOf("recordVersion", BigDecimal.class);
