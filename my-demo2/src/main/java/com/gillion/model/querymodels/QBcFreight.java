...
public class QBcFreight extends BaseModelExpression<BcFreight, BigDecimal> {

    public static final BaseModelExpression<BcFreight, BigDecimal> bcFreight = new QBcFreight();
    public static final FieldExpression<BigDecimal> bcFreightId = bcFreight.fieldOf("bcFreightId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> bcPublicOrderId = bcFreight.fieldOf("bcPublicOrderId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> bcLedgerCompId = bcFreight.fieldOf("bcLedgerCompId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> bcInvoiceId = bcFreight.fieldOf("bcInvoiceId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> bcPaymentRequestId = bcFreight.fieldOf("bcPaymentRequestId", BigDecimal.class);
    public static final FieldExpression<BigDecimal> bcAllocationEventId = bcFreight.fieldOf("bcAllocationEventId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> sourceFreightId = bcFreight.fieldOf("sourceFreightId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> replaceId = bcFreight.fieldOf("replaceId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> bcChargeId = bcFreight.fieldOf("bcChargeId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> glVoucherId = bcFreight.fieldOf("glVoucherId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> diffTaxesVoucherId = bcFreight.fieldOf("diffTaxesVoucherId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> writeoffId = bcFreight.fieldOf("writeoffId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> noOfPeriod = bcFreight.fieldOf("noOfPeriod", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> recordVersion = bcFreight.fieldOf("recordVersion", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> bcPaymentRequestDocId = bcFreight.fieldOf("bcPaymentRequestDocId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> bcChequeId = bcFreight.fieldOf("bcChequeId", BigDecimal.class);
