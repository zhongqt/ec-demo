...
public class QMdFreightCode extends BaseModelExpression<MdFreightCode, BigDecimal> {

    public static final BaseModelExpression<MdFreightCode, BigDecimal> mdFreightCode = new QMdFreightCode();
    public static final FieldExpression<BigDecimal> mdFreightCodeId = mdFreightCode.fieldOf("mdFreightCodeId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> recordVersion = mdFreightCode.fieldOf("recordVersion", BigDecimal.class);
