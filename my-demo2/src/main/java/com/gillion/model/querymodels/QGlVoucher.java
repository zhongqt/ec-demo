...
public class QGlVoucher extends BaseModelExpression<GlVoucher, BigDecimal> {

    public static final BaseModelExpression<GlVoucher, BigDecimal> glVoucher = new QGlVoucher();
    public static final FieldExpression<BigDecimal> glVoucherId = glVoucher.fieldOf("glVoucherId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> recordVersion = glVoucher.fieldOf("recordVersion", BigDecimal.class);
