...
public class QCsCust extends BaseModelExpression<CsCust, BigDecimal> {

    public static final BaseModelExpression<CsCust, BigDecimal> csCust = new QCsCust();
    public static final FieldExpression<BigDecimal> csCustId = csCust.fieldOf("csCustId", BigDecimal.class);
    ...
    public static final FieldExpression<BigDecimal> recordVersion = csCust.fieldOf("recordVersion", BigDecimal.class);
