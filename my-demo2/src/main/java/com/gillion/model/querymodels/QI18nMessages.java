...
public class QI18nMessages extends BaseModelExpression<I18nMessages, Long> {
    ...
    public static final FieldExpression<String> projectKey = i18nMessages.fieldOf("projectKey", String.class);
    public static final FieldExpression<Byte> type = i18nMessages.fieldOf("type", Byte.class);
    public static final FieldExpression<Boolean> destroyed = i18nMessages.fieldOf("destroyed", Boolean.class);
