...
@SuppressWarnings("JpaDataSourceORMInspection")
    ...
    @Data
    @Entity
@Table(name = "food_arrival_month_report")
public class FoodArrivalMonthReport extends BaseModel implements Serializable{
private static final long serialVersionUID=1;

    /**主键id*/
    @Id
    @Column(name = "food_arrival_month_report_id")
    @JsonSerialize(using = Long2String.class)
    @JsonDeserialize(using = String2Long.class)
    @Generator("snowFlakeGenerator")
    private Long foodArrivalMonthReportId;
