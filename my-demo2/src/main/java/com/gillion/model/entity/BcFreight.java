...
private static final long serialVersionUID=1;
    ...
    private BigDecimal bcFreightId;

    /**公共订单主键*/
    @Column(name = "bc_public_order_id")
    private BigDecimal bcPublicOrderId;

    /**账单主键*/
    @Column(name = "bc_ledger_comp_id")
    private BigDecimal bcLedgerCompId;

    /**发票主键*/
    @Column(name = "bc_invoice_id")
    private BigDecimal bcInvoiceId;

    /**请款单主键*/
    @Column(name = "bc_payment_request_id")
    private BigDecimal bcPaymentRequestId;

    /**核销主键*/
    @Column(name = "bc_allocation_event_id")
    private BigDecimal bcAllocationEventId;
    ...
    private BigDecimal sourceFreightId;
...
Y 是 N 否  默认为N*/
    ...
    private BigDecimal glVoucherId;
    ...
    private BigDecimal diffTaxesVoucherId;
    ...
    private BigDecimal bcPaymentRequestDocId;
