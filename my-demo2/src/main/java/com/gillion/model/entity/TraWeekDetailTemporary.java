...
@SuppressWarnings("JpaDataSourceORMInspection")
    ...
    @Data
    @Entity
@Table(name = "tra_week_detail_temporary")
public class TraWeekDetailTemporary extends BaseModel implements Serializable{
private static final long serialVersionUID=1;

    /**主键ID*/
    @Id
    @Column(name = "tra_week_detail_temporary_id")
    @JsonSerialize(using = Long2String.class)
    @JsonDeserialize(using = String2Long.class)
    @Generator("snowFlakeGenerator")
    private Long traWeekDetailTemporaryId;
