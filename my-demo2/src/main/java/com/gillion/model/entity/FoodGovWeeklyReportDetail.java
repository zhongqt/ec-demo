...
@SuppressWarnings("JpaDataSourceORMInspection")
    ...
    @Data
    @Entity
@Table(name = "food_gov_weekly_report_detail")
public class FoodGovWeeklyReportDetail extends BaseModel implements Serializable{
private static final long serialVersionUID=1;

    /**主键id*/
    @Id
    @Column(name = "gov_weekly_report_detail_id")
    @JsonSerialize(using = Long2String.class)
    @JsonDeserialize(using = String2Long.class)
    @Generator("snowFlakeGenerator")
    private Long govWeeklyReportDetailId;
    ...
    /**滞留原因和下步举措*/
    @Column(name = "detention_reasons_and_next_steps")
    private String detentionReasonsAndNextSteps;
